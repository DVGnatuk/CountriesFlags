...
extension UIImage {
    public static func flag(for country: CountriesFlags, with size: CGSize) -> UIImage? {
        ...
        case .Australia: return flagAustralia(with: size)
        case .Austria: return flagAustria(with: size)
        case .Azerbaijan: return flagAzerbaijan(with: size)
        ...
        case .CookIslands: return flagCookIslands(with: size)
        ...
        case .Israel: return flagIsrael(with: size)
        ...
        case .Libya: return flagLibya(with: size)
        ...
        case .Malaysia: return flagMalaysia(with: size)
        case .Maldives: return flagMaldives(with: size)
        case .Mali: return flagMali(with: size)
        case .MarshallIslands: return flagMarshallIslands(with: size)
        case .Martinique: return flagMartinique(with: size)
        case .Mauritania: return flagMauritania(with: size)
        ...
        case .Morocco: return flagMorocco(with: size)
        case .Myanmar: return flagMyanmar(with: size)
        case .Namibia: return flagNamibia(with: size)
        ...
        case .NewZealand: return flagNewZealand(with: size)
        case .Niger: return flagNiger(with: size)
        case .Nigeria: return flagNigeria(with: size)
        case .Niue: return flagNiue(with: size)
        case .NorthMacedonia: return flagNorthMacedonia(with: size)
        case .Norway: return flagNorway(with: size)
        case .Pakistan: return flagPakistan(with: size)
        ...
        case .Slovakia: return flagSlovakia(with: size)
        case .SolomonIslands: return flagSolomonIslands(with: size)
        case .Somalia: return flagSomalia(with: size)
        case .SouthAfrica: return flagSouthAfrica(with: size)
        case .SovietUnion: return flagSovietUnion(with: size)
        ...
        case .Taiwan: return flagTaiwan(with: size)
        ...
        case .Tunisia: return flagTunisia(with: size)
        case .Turkey: return flagTurkey(with: size)
        case .Tuvalu: return flagTuvalu(with: size)
        case .Ukraine: return flagUkraine(with: size)
        case .UnitedArabEmirates: return flagUnitedArabEmirates(with: size)
        case .UnitedKingdom: return flagUnitedKingdom(with: size)
        case .UnitedStatesOfAmerica: return flagUnitedStatesOfAmerica(with: size)
        case .Uzbekistan: return flagUzbekistan(with: size)
